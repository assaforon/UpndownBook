...
point90qzoom = sideside(p90wstack[estimate != 'dm48', ], metric = 'MAE95', titl = 'MAE95, 90th Percentile, Weibull Curves, w/o Dixon-Mood') 
...
point30wq = sideside(p30wstack[!grepl('Group', Design), ], metric = 'MAE95', titl = 'MAE95, 30th Percentile, Weibull Curves') 
...
point30lq = sideside(p30lstack[!grepl('Group', Design), ], metric = 'MAE95', titl = 'MAE95, 30th Percentile, Logistic Curves') 
...
point30gwq = sideside(p30wstack[estimate %in% gpoints, ], metric = 'MAE95', titl = 'MAE95, 30th Percentile, Weibull Curves', colkey=colors4) 
...
point30glq = sideside(p30lstack[estimate %in% gpoints, ], metric = 'MAE95', titl = 'MAE95, 30th Percentile, Logistic Curves', colkey=colors4) 
...
point50q = sideside(p50stack, metric = 'MAE95', titl = 'MAE95, 50th Percentile, Logistic Curves') 
